import { CategoriesModel } from "../../common/database/models/categories";
...
export class CategoriesService {
  ...
  public async createCategory(
    ...
    return this.categoriesRepository.createCategory({ ...params, status: UserStatusEnum.ACTIVE } as CategoriesModel);
  }
  ...
  public async createMoreCategories(
    ...
    for(let i =0; i < params.name.length; i++) {
      data.push({ name: params.name[i], status: UserStatusEnum.ACTIVE } as CategoriesModel);
    }
